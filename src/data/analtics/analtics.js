...
// var numKs = document.getElementById("num-ks");
// var numPeriods = document.getElementById("num-periods");
...
addon.port.on("passStats",function(data){
	...
	// numKs.innerHTML		= data.page.kCnt + " k's found ";
	// numPeriods.innerHTML= data.page.periodCnt + " . found"; 
